...
export declare class RootChainManager extends eth.Contract {
    ...
    renounceRole(role: string | number[], account: string, options?: EstimateGasOptions): Promise<string>;
    revokeRole(role: string | number[], account: string, options?: EstimateGasOptions): Promise<string>;
    ...
    setChildChainManagerAddress(newChildChainManager: string, options?: EstimateGasOptions): Promise<string>;
    registerPredicate(tokenType: string | number[], predicateAddress: string, options?: EstimateGasOptions): Promise<string>;
    mapToken(rootToken: string, childToken: string, tokenType: string | number[], options?: EstimateGasOptions): Promise<string>;
    depositEtherFor(user: string, options?: EstimateGasOptions): Promise<string>;
    depositFor(user: string, rootToken: string, depositData: string | number[], options?: EstimateGasOptions): Promise<string>;
